...
const Hero = () => {
  return (
    <section className="hero-section min-h-screen flex items-center justify-center pt-16 pb-6 relative">
      <div className="section-container relative z-10 text-center max-w-5xl mx-auto">
        {/* Badge inovador mais clean */}
        <div className="mb-6 animate-slide-in">
          <div className="inline-flex items-center px-3 py-1.5 bg-white/10 backdrop-blur-md border border-[#18d7af]/30 text-[#18d7af] rounded-full shadow-lg">
        ...
        <div className="mb-8 animate-slide-in space-y-3" style={{ animationDelay: "0.2s" }}>
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight">
            <span className="block text-white mb-1">Somos a</span>
          ...
          <div className="bg-white/5 backdrop-blur-md p-4 rounded-2xl border border-[#18d7af]/20 max-w-2xl mx-auto shadow-2xl">
        ...
        <div className="mb-6 animate-slide-in" style={{ animationDelay: "0.4s" }}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto mb-6">
            <div className="group flex items-center gap-3 p-4 bg-white/5 backdrop-blur-md rounded-xl border border-[#18d7af]/20 hover:border-[#18d7af]/40 transition-all duration-300 hover:transform hover:scale-105">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center animate-slide-in" style={{ animationDelay: "0.6s" }}>
