        ...
        <section className="pt-24 pb-16">
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => <div key={index} className="service-card group cursor-pointer p-6 bg-gradient-to-br from-brand-accent/10 to-transparent border border-brand-accent/20 rounded-2xl backdrop-blur-sm hover:border-brand-accent/40 hover:bg-brand-accent/15 transition-all duration-500" style={{
              opacity: 0,
            ...
            <div className="text-center mt-16">
              <div className="bg-gradient-to-r from-brand-accent/10 to-transparent p-8 rounded-2xl border border-brand-accent/20 backdrop-blur-sm max-w-4xl mx-auto">
                ...
                <Button size="lg" className="btn-primary group" onClick={() => {
